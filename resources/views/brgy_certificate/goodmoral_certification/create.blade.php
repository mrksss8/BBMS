...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Brgy Good Moral Issuance</h3>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="section-lead">
                        Requesting for Brgy Good Moral Certificate
                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6">
                            <div class="card"  id = "border-blue" style = "margin-top: 35px;">
                                ...
                                <form action="{{route('brgy_goodmoral.show', $resident->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                    ...
                                    <div class="card-footer d-flex justify-content-center">
                                        <button type = "submit"  class="btn btn-lg btn-icon icon-left btn-success"><i class="far fa-edit"></i> Generate Good Moral Certificate </button>      
                                    </div>
                                    </form>
