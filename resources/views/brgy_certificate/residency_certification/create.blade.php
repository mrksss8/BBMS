...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Brgy Residency Issuance</h3>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="section-lead">
                        Requesting for Brgy Residency Certificate
                    </p>
                            ...
                            <div class="card "  style = "margin-top: 35px;" id = "border-blue">
                                ...
                                <form action="{{route('brgy_residency.show', $resident->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer d-flex justify-content-center">
                                        <button type = "submit"  class="btn btn-lg btn-icon icon-left btn-success"><i class="far fa-edit"></i> Generate Brgy Residency Certificate </a>      
                                    </div>
                                    </form>
