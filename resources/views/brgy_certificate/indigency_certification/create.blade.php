...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Brgy Indigency Issuance</h3>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="section-lead">
                        Requesting for Brgy Indigency Certificate
                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6">
                            <div class="card" style = "margin-top: 35px;" id = "border-blue">
                                ...
                                <form action="{{route('brgy_indigency.show', $resident->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Dahilan ng pagkuha</label>
                                    ...
                                    <div class="card-footer d-flex justify-content-center">
                                        <button type = "submit"  class="btn btn-lg btn-icon icon-left btn-success"><i class="far fa-edit"></i> Generate Brgy Indigency Certificate </a>      
                                    </div>
                                    </form>
