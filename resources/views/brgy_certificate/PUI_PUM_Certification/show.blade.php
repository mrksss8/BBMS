...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Brgy PUI-PUM Certificate</h3>
        </div>
        <div class="d-flex">
                                    ...
                                    <div class="text-part">
                                        ...
                                        <p id="content">
                                            This is to certify that <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }}</strong> of legal age and bonafide resident of <strong>Purok-{{ $resident->purok}} {{ $resident->street}}, Barangay Bayog, Los Baños, Laguna.</strong> 
                                        </p>
                                        <p id="content">
                                            This is to certify further that <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }}</strong> is not a Person Under Monitoring (PUM) nor a Person Under Investigation (PUI) in relation to COVID 19 while he/she is in the barangay. 
                                        </p>
                                        <P id="issue-for">
                                            This CERTIFICATION is being issued upon the request of <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }}</strong> for any legal purpose this may serve.
                                        </P>
