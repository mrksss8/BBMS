                    ...
                    <div class="wrapper">
                        <div class="header">
                            ...
                            <div class="title-wrapper">
                                <h1 style="border-left: 2px solid black; border-right: 2px solid black;">Barangay Income Certificate</h1>
                            </div>
                        </div>
                                    ...
                                    <div class="text-part">
                                        ...
                                        <p id="content">
                                            Ito ay pagpapatunay na si <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }} {{ $resident->suffix_name }}</strong>,   <strong>{{ \Carbon\Carbon::parse($resident->birthday)->diff(\Carbon\Carbon::now())->format('%y') }}</strong> taong gulang  ipinanganak noong <strong>{{ date('M d, Y', strtotime($resident->birthday)) }} sa {{ $resident->birthplace}} at nakatira sa <strong>Purok-{{ $resident->purok}} {{ $resident->street}}</strong>, Barangay Bayog, Los Baños, Laguna.</strong>.                                                                                
                               
                                           
                                        <P id="issue-for">
                                            Pagpapatunay din na si  <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }} {{ $resident->suffix_name }}</strong>, ay {{ $resident->occupation}}  na kanyang pinagkakakitaan. </strong>
