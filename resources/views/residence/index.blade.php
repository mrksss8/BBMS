...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <a href="{{route('residence.create')}}" class="btn btn-icon icon-left btn-primary mr-3"><i class="far fa-edit"></i> Register Residence </a>
            </div>
        </div>
                                ...
                                <div class="col-12">
                                  <div class="card">
                                    <div class="card-header">
                                      <h3 class = "text-primary ">Residence List</h3>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            @foreach ($residence_list as $residence)
                                                <tr>
                                                  <td><div class = "row d-flex justify-content-center">
                                                    <a href ="{{route('residence.show', $residence->id)}}" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="View"><i class="fas fa-eye"></i></a>
