...
<div class="main-sidebar"> 
    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a class="nav-link" href ="{{route ('analytics.index')}}"><i class="fas fa-users"></i><span>Brgy Analytics</span></a></li>
        ...
        <li><a class="nav-link" href ="{{route('reports.index')}}"><i class="fas fa-file"></i><span>Reports</span></a></li>
      </ul>
    </aside>
  </div>