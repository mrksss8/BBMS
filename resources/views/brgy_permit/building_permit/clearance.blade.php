    ...
    <section class="section">
                            ...
                            <div class="content" style="width: 5.55in; border-right: 2px solid black;">
                                 <div class="content-wrapper">
                                    ...
                                    <div class="text-part" style = "margin-top:100px;">
                                        ...
                                        <p id="content">
                                            Permit is hereby granted to Mr./Mrs. <strong>{{$building->building_owner}}</strong> to construct and renovate a proposed  <strong> {{$building->building_type}}</strong>  located at  <strong>{{$building->building_address}}</strong>.
                                           
                                        <P id="issue-for">
                                            SUBJECT, however to the provision of our existing laws, ordinances and regulation governing the operation and maintenance of the SAME.
                                        </P>

                                        <P id="issue-for">This <strong>BARANGAY BUILDING CLEARANCE </strong>may be revoked at any time when necessary to protect, rules and regulations governing the operation and maintenance of the same.</p>
        ...
        <script type="text/javascript">
            function generatepdf() {
                ...
                var opt = {
                    margin: 0,
                    filename: 'BuildingClearance.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 0.98
                    },
