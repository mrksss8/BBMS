...
class BarangayIncomeController extends Controller
{
    ...
    public function show($id, Request $request){
        ...
        return view('brgy_certificate.income_certification.show',compact('resident','purpose', 'b_cap','b_councelor1','b_councelor2','b_councelor3','b_councelor4','b_councelor5','b_councelor6' ,'b_councelor7', 'b_sk', 'b_sec' , 'b_tres', 'b_clerk')); 
    }
}
